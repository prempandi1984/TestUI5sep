		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#actfinarzsampleproj-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"actfinarzsampleproj-display": {
								"semanticObject": "actfinarzsampleproj",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=act.fin.ar.zsampleproj",
									"url": sap.ui.require.toUrl("act/fin/ar/zsampleproj")
								}
							}
						}
					}
